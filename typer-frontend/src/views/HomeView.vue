<template>
    <div>
        ...
        <div class="flex justify-around py-20" id="container">
            <button @click="test(group['_id'])" class="inline-block h-80 w-60 text-center pt-2 bg-gray-100 rounded-xl" v-for="(group, index) in groups" :key="group.name" @deleted="removeGroup(index)" :documentInfo="group">  
